...
public class Inventory : MonoBehaviour {
	...
	void Start () {
        ...
        for (int x = 0; x < numberOfSlots; x++)
        {
            ...
            slot.GetComponent<RectTransform>().localPosition = new Vector3(x * 40, 0, 0);
            slot.name = "Slot " + x;
        ...
        AddItemToEmptySlot(new WeaponItem(_Data.GetWeaponBlueprint(0), _Data.GetCraftingMaterial(0)));
        AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(0), _Data.GetCraftingMaterial(0)));
        AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(1), _Data.GetCraftingMaterial(0)));
        AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(2), _Data.GetCraftingMaterial(0)));
        //AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(2), _Data.GetCraftingMaterial(0)));
        AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(3), _Data.GetCraftingMaterial(0)));
        //AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(3), _Data.GetCraftingMaterial(0)));
        AddItemToEmptySlot(new EquipmentItem(_Data.GetEquipmentBlueprint(4), _Data.GetCraftingMaterial(0)));
	}
    ...
    void AddItemToEmptySlot( Item a_item)
    {
    ...
    bool AddItemToStack(Item a_item)
    {
        for (int i = 0; i < items.Count; i++)
        {
            if (items[i].item == a_item)
            {
